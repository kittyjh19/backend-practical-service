...
### 3️⃣ 게시글 목록 조회 (최신글 / 인기글)

전체 게시글 목록을 조회합니다.
본 API는 최신글 조회와 함께, 좋아요 수 기준의 인기 게시글 조회 기능을 옵션으로 제공합니다.
...
| limit | Integer | 조회 개수 (기본값: 10, 인기글 조회 시 적용) |
...
* `sort=popular` 옵션 사용 시 좋아요 수가 많은 상위 10개의 게시글을 조회
